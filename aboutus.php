            ...
            <div class="aboutusPartieDroite__partieTextes">
                ...
                <div>
                    <div class="aboutusPartieDroite__bloc">
                        ...
                        <div>
                            <h1 class="aboutusPartieDroite__blocsTitre"><?php echo get_theme_mod('aboutus_bloc1title') ?></p>
                    ...
                    <div class="aboutusPartieDroite__bloc">
                        ...
                        <div>
                            <h1 class="aboutusPartieDroite__blocsTitre"><?php echo get_theme_mod('aboutus_bloc2title') ?></p>
